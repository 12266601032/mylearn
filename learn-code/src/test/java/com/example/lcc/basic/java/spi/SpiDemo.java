package com.example.lcc.basic.java.spi;
...
public class SpiDemo {
    ...
    public void serviceLoader() throws ClassNotFoundException {
         ...
         * 本例的话就是
         * META-INF/services/com.example.lcc.basic.java.spi.SpiDemo$ServiceAPI
         * 在com.example.lcc.basic.java.spi.SpiDemo.ServiceAPI中加入com.example.lcc.basic.java.spi.SpiDemo$ConcreteAAA
         *
         * 如果有多个可以直接都写入
         * com.example.lcc.basic.java.spi.SpiDemo$ConcreteAAA
         * com.example.lcc.basic.java.spi.SpiDemo$ConcretePPP
         * com.example.lcc.basic.java.spi.SpiDemo$ConcreteIII
         */
