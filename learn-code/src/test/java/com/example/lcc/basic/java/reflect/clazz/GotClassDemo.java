...
public class GotClassDemo {
     ...
     * 三、根据全路径类名获取class对象
     * Class<?> aClass = Class.forName("com.example.lcc.basic.java.reflect.clazz.GotClassDemo");
     *
     *
    ...
    public void clazz() throws Exception {
        ...
        Class<?> aClass3 = Class.forName("com.example.lcc.basic.java.reflect.clazz.GotClassDemo");
